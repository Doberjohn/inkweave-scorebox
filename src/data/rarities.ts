...
export const RARITIES: readonly Rarity[] = [
  { id: "foil-rare",       name: "Foil Rare",       short: "Rare",       points: RARITY_POINTS["foil-rare"],       ink: "steel",     icon: rarityRare,       foil: true  },
  ...
  { id: "foil-super-rare", name: "Foil Super Rare", short: "Super Rare", points: RARITY_POINTS["foil-super-rare"], ink: "emerald",   icon: raritySuperRare,  foil: true  },
  ...
  { id: "foil-legendary",  name: "Foil Legendary",  short: "Legendary",  points: RARITY_POINTS["foil-legendary"],  ink: "amber",     icon: rarityLegendary,  foil: true  },
